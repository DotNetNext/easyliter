...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //从数据库创建类
            var createCalss1 = e.CreateClass("Sqlite.Model"/*命名空间*/, @"C:\Users\skx\Downloads\Sqlite\Sqlite\model1"/*路径*/);

            //根据SQL语句创建类,多表查询会用到
            var createCalss2 = e.CreateClassBySql("Sqlite.Model", @"C:\Users\skx\Downloads\Sqlite\Sqlite\model1", "viewproduct", "select id,sku from product ");
